...
<body class="maintanence text-center">
    ...
    <div class="container-fluid maintanence-content">
        <div class="">
            ...
            <a href="/cree" style=" background-image: linear-gradient(135deg, #1b55e2 0%, #1ac333 100%);" class="btn btn-primary mt-4">Cree</a>
            <a href="/rejoindre" style="     background-image: linear-gradient(135deg, #f42b30 0%, #1ac333 100%);" class="btn btn-primary mt-4">Rejoindre</a>
        </div>
